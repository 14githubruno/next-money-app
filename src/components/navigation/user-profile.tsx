...
export function UserProfileDesktop({ user }: UserProfileProps) {
  return (
...
export function UserProfileMobile({ user }: UserProfileProps) {
  return (
    <DropdownUserProfile user={user} align="end">
      <Button
        aria-label="User settings"
        variant="ghost"
        className={cx(
          "group flex items-center p-1 text-sm font-medium text-gray-900 hover:bg-gray-100 data-[state=open]:bg-gray-100 hover:dark:bg-gray-400/10 dark:data-[state=open]:bg-gray-400/10"
        )}
      >
        <span
