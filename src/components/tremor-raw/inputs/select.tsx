...
const selectTriggerStyles = [
  cx(
    // base
    "group/trigger flex w-full rounded-lg select-none items-center justify-between gap-2 truncate border px-3 py-2 shadow-xs outline-hidden transition sm:text-sm",
    // border color
  ...
  (
    ...
    <SelectPrimitives.Portal>
      <SelectPrimitives.Content
        ...
        className={cx(
          // base
          "relative z-50 overflow-hidden rounded-3xl border shadow-xl shadow-black/[2.5%]",
          // widths
...
>(({ className, children, ...props }, forwardedRef) => {
  return (
    <SelectPrimitives.Item
      ...
      className={cx(
        // base
        "grid cursor-pointer grid-cols-[1fr_20px] gap-x-2 rounded-md px-3 py-2 outline-hidden transition-colors data-[state=checked]:font-semibold sm:text-sm",
        // text color
        "text-gray-900 dark:text-gray-50",
        // disabled
